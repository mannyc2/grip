...
import { AccessKeyDetailContent } from '../../_components/content/access-key-detail-content';

interface Props {
  params: Promise<{ id: string }>;
}

export default async function AccessKeyDetailPage({ params }: Props) {
  ...
  return <AccessKeyDetailContent accessKey={formattedKey} variant="page" />;
}
