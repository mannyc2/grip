...
export const member = pgTable(
  'member',
  {
    ...
    createdAt: timestamp('created_at').notNull(),
    sourceType: text('source_type').default('manual_invite'),
    githubOrgRole: text('github_org_role'),
  },
  (table) => [
...
export const accessKeyRootWalletIdRelations = relations(accessKey, ({ one }) => ({
  wallet: one(wallet, {
...
export const accessKeyKeyWalletIdRelations = relations(accessKey, ({ one }) => ({
  wallet: one(wallet, {
